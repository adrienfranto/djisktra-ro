                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      {nodes.map(node => (
                        <th key={node.id} scope="col" className="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                          {node.label}
                        </th>
                      ))}
                    </tr>
                    ...
                    {calculationSteps.map((step, index) => (
                      <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                        ...
                        {nodes.map(node => {
                          ...
                          return (
                            <td key={node.id} className={`px-4 py-2 whitespace-nowrap text-sm text-center ${
                              isUpdated ? 'bg-green-100' : 
                              node.id === step.current ? 'bg-blue-100' : ''
                            }`}>
